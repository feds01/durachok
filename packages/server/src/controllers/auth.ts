...
export class AuthService {
     ...
     */
    private verifyTokenPayload(rawPayload: string | jwt.JwtPayload | undefined): TokenPayload | undefined {
        if (!isDef(rawPayload)) {
            return undefined;
        }
     ...
     */
    public async createTokens(payload: RawTokenPayload["data"]): Promise<Tokens> {
    ...
    public async refreshTokens(
        ...
        const decodedToken = await this.verifyToken(refreshToken, JWT_REFRESH_SECRET);
